...
This repository contains the `kafka-gitops` CLI for managing Kafka topics, ACLs, Schema Registry subjects, and Confluent Cloud service-account workflows from desired-state YAML.
...
- Treat Schema Registry credentials as sensitive. Do not log basic-auth passwords or authorization headers.
